...
class CustomFieldService
{
     ...
     *                                 'type' => 'select',               // Тип: text|textarea|date|datetime|select|multiselect|checkbox
    ...
    private function createFieldValueModel(string $type): BaseCustomFieldValuesModel
    {
        return match ($type) {
            ...
            'checkbox' => new \AmoCRM\Models\CustomFieldsValues\CheckboxCustomFieldValuesModel,
    ...
    private function createValueCollection(string $type, mixed $value): BaseCustomFieldValueCollection
    {
        return match ($type) {
            ...
            'checkbox' => $this->createCheckboxValueCollection($value),
    ...
    private function createCheckboxValueCollection(mixed $value): \AmoCRM\Models\CustomFieldsValues\ValueCollections\CheckboxCustomFieldValueCollection
    {
        $valueModel = new \AmoCRM\Models\CustomFieldsValues\ValueModels\CheckboxCustomFieldValueModel;
        $valueModel->setValue((bool) $value);

        return (new \AmoCRM\Models\CustomFieldsValues\ValueCollections\CheckboxCustomFieldValueCollection)->add($valueModel);
    }
